...
function render(variables = {}) {
  ...
  newVar.forEach(atrib => {
    if (variables[atrib] === null) {
      variables[atrib] = `${atrib}`;
    }
  });
  console.log(newVar);
  ...
  if (variables.twitter === null) variables.twitter = "Your twitter";
  if (variables.github === null) variables.github = "Your github";
  if (variables.linkedin === null) variables.linkedin = "Your linkedin";
  if (variables.instagram === null) variables.instagram = "Your instagram";
